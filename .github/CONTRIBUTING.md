...
If you wish to contribute to nhl-kruispunt, feel free to fork the repository and submit a pull request.
...
## Prerequisites
The following prerequisites must be met before installing nhl-kruispunt:
...
2. Run pnpm i
3. Code your ideas and test them using pnpm run dev
4. [Submit a pull request](https://github.com/wessel/nhl-kruispunt/compare)
